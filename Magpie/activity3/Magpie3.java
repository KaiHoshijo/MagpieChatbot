...
public class Magpie3
{
    ...
    public String getResponse(String statement)
    {
        ...
        } else if (findKeyword(statement,"cooper") >= 0) {
            response = "She sounds like a good teacher.";
        } else if (findKeyword(statement,"hate") >= 0) {
            response = "hate is such a strong word";
        } else if (findKeyword(statement,"how is your day") >= 0 || findKeyword(statement,"how\'s your day") >= 0) {
            response = "It is going as well as it can for a nonliving being.";
        } else if (findKeyword(statement,"what is the meaning of life") >= 0
                || findKeyword(statement,"what\' the meaning of life") >= 0) {
